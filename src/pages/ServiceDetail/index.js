...
import { services as listServices } from '../../redux/selectors';

import { addServices, updateServices, deleteServices } from '../../redux/Services/services.actions';
...
export default function ServiceDetail() {
    ...
    const { services } = useSelector(listServices);
    ...
    const create = (values) => {
        ...
        dispatch(addServices({ id: 0, name, description }));
                    ...
                    <form onSubmit={data ? handleSubmit(edit) : handleSubmit(create)}>
                        <div className="grid grid-cols-6 flex flex-row">
                            <div className="col-span-6  sm:col-span-5">
                                <ServicesForm data={data} register={register} errors={errors} />
                            </div>
