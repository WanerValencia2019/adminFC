...
function TableUsers({ data }) {
    ...
    const renderEditModal = (user) => (
        <RoleForm data={user} cancel={() => setShowModal(false)} confirm={handleEditSubmit} />
    );
    ...
    const handleCreate = () => {
        setForm(<RoleForm cancel={() => setShowModal(false)} confirm={handleAddSubmit} />);
        setShowModal((prev) => !prev);
    };
        ...
        <div className="col-span-full xl:col-span-6 bg-white shadow-lg rounded-sm border border-gray-200">
            <header className="px-5 py-4 border-b border-gray-100  ">
                <div className="flex flex-column justify-between">
                    <h2 className="font-semibold text-gray-800 ">Metódos de pago</h2>
                    <PlusCircleIcon
                    ...
                    <table className="table-auto w-full">
                        ...
                        <thead className="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                            <tr>
                                ...
                                <th className="p-2 whitespace-nowrap">
                                    <div className="font-semibold text-left">Fecha de creación</div>
                                </th>
                                <th className="p-2 whitespace-nowrap">
                                ...
                                data.map((role) => {
                                    return (
                                        <tr key={role.id}>
                                            ...
                                            >
                                                <p className="text-green-700 text-left role">
                                                    {role.name}
                                                </p>
                                            </td>
                                            ...
                                            <td className="p-2 whitespace-nowrap">
                                                <div className="font-medium text-gray-800">
                                                    {role.status ? (
                                                        ...
                                                        <p className="text-red-400">Inactivo</p>
                                                    )}
                                                </div>
                                            </td>
                                            <td className="p-2 whitespace-nowrap">
