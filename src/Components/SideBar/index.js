                    ...
                    <ul className="mt-3">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex flex-grow">
                                        ...
                                        >
                                            <path
                                                className={`fill-current text-gray-400 ${
                                                    page === 'interests' && 'text-indigo-300'
                                                }`}
                                                d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                                            />
                                            <path
                                                className={`fill-current text-gray-700 ${
                                                    page === 'interests' && 'text-indigo-600'
                                                }`}
                                                d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                                            />
                                            <path
                                                className={`fill-current text-gray-600 ${
                                                    page === 'interests' && 'text-indigo-500'
                                                }`}
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex flex-grow">
                                        ...
                                        >
                                            ...
                                            <path
                                                className={`fill-current text-gray-400 ${
                                                    page.startsWith('services') && 'text-indigo-300'
                                                }`}
                                                d="M12 6a3 3 0 110-6 3 3 0 010 6zm2 18h-4a1 1 0 01-1-1v-6H6v-6a3 3 0 013-3h6a3 3 0 013 3v6h-3v6a1 1 0 01-1 1z"
                                            />
                                        </svg>
                            ...
                            >
                                <div className="flex flex-grow">
                                    <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                                        ...
                                        <path
                                            className={`fill-current text-gray-400 ${
                                                page === 'paymentTypes' && 'text-indigo-300'
                                            }`}
                        ...
                        >
                            <NavLink
                                exact
                                to="/"
                                className={`opacity-5 block text-gray-200 hover:text-white transition duration-150 ${
